...
class FunkinPreloader extends FlxBasePreloader
{
  ...
  override function create():Void
  {
    ...
    var progressLeftTextFormat:TextFormat = new TextFormat("DS-Digital", Std.int(32 * ratio), 0xFFA4FF11, true);
    progressLeftTextFormat.align = TextFormatAlign.LEFT;
    var progressRightTextFormat:TextFormat = new TextFormat("DS-Digital", 16, 0xFFA4FF11, true);
    progressRightTextFormat.align = TextFormatAlign.RIGHT;

    progressLeftText = makeText(BAR_PADDING * ratio, progressLines.y, 'Downloading assets...', 0xFFA4FF11);
    ...
    progressRightText = makeText(BAR_PADDING, this._height - BAR_PADDING - BAR_HEIGHT - 16 - 4, '0%', 0xFFA4FF11);
    ...
    rTextGroup.graphics.beginFill(0xFFA4FF11, 1);
    ...
    rTextGroup.graphics.beginFill(0xFFA4FF11, 0.1);
    ...
    enhancedText = makeText(-100, 40, 'ENHANCED', 0xFFA4FF11);
    enhancedText.width = this._width;
    enhancedText.height = 100;
    rTextGroup.addChild(enhancedText);

    stereoText = makeText(0, 0, 'STEREO', 0xFFA4FF11);
  ...
  function updateProgressLeftText(text:Null<String>):Void
  {
    ...
    else if (progressLeftText.text != text)
    {
      ...
      progressLeftText.defaultTextFormat = new TextFormat("DS-Digital", 32, 0xFFA4FF11, true);
