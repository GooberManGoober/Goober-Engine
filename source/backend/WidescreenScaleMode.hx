...
class WidescreenScaleMode extends BaseScaleMode
{
  /**
  ...
  /**
   * Singleton instance of the `WidescreenScaleMode`.
   */
  public static var instance:WidescreenScaleMode = null;
  ...
  /**
   * Constructor for `WidescreenScaleMode`.
   *
   ...
   * It's used in WidescreenScaleMode to prevent weird window resolutions from being counted as wide screen since those were causing issues positioning the game
